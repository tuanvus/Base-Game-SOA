...
namespace LTA.Base
{
    ...
    public class Utils
    {
        public static void GetComponent<T>(GameObject gameObject,bool autoAdd)
        {
        ...
        public static string ConvertMoneyToString(long money)
        {
            ...
            {
                throw new Exception("LTA.Base.Utils.ConvertMoneyToString(long money) + :"  + ex.Message);
            }
        }
        ...
        public static DateTime UnixTimeToDateTime(long unixtime)
        {
            ...
            dateDateTime = dateDateTime.AddMilliseconds(unixtime).ToLocalTime();
            return dateDateTime;
        }
